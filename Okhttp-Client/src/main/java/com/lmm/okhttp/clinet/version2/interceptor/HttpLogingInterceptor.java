package com.lmm.okhttp.clinet.version2.interceptor;
...
/**
 * desc   : HttpLogingInterceptor
 * author : fei
 * date   : 2021/02/22
 * version: 1.0
 * 版权所有:雷漫网络科技
 */
public class HttpLogingInterceptor implements Interceptor {
    ...
    public HttpLogingInterceptor() {
        this(Logger.DEFAULT);
    }

    public HttpLogingInterceptor(Logger logger) {
        this.logger = logger;
    }
