 ...
 *
 * 通过接口提供已打开键盘的高度，主要处理Android组件的生命周期事件
 */
public class KeyboardAwareLinearLayout extends LinearLayoutCompat {
    ...
    public KeyboardAwareLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        minKeyboardSize = SizeUtil.dip2Px(50,context);
        minCustomKeyboardSize = SizeUtil.dip2Px(110,context);
        defaultCustomKeyboardSize = SizeUtil.dip2Px(250,context);
        minCustomKeyboardTopMargin = SizeUtil.dip2Px(170,context);
