...
import static com.example.uiconponent.smartslide.SlideConsumer.DIRECTION_ALL;
import static com.example.uiconponent.smartslide.SlideConsumer.DIRECTION_BOTTOM;
import static com.example.uiconponent.smartslide.SlideConsumer.DIRECTION_LEFT;
import static com.example.uiconponent.smartslide.SlideConsumer.DIRECTION_RIGHT;
import static com.example.uiconponent.smartslide.SlideConsumer.DIRECTION_TOP;
...
public class ScrimView extends View {
    ...
    public void setProgress(float progress) {
        float mProgress = SmartSlide.ensureBetween(progress, MIN_PROGRESS, MAX_PROGRESS);
